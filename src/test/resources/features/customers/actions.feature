Feature: Customer Action Functionality
  ...
  Scenario: 1. Verify reset pin approval action process
  ...
  Scenario: 2. Verify access control denied actions process
    Given I have a valid access token for the user "zolam"
    And I send a POST request to "ep_user_passcode_login" with the passcode "Abc@123"
...
#  Scenario: 3. Verify access control approval action process
#    Given I have a valid access token for the user "zolam"
...
#
#  Scenario: 2. Verify Detach Phone  denied actions process
#    Given I have a valid access token for the user "zolam"
#    And I send a POST request to "ep_user_login" with the passcode "Abc@123"
#    When I send a POST request to "ep_customer_action_detach_phone_get_OTP_maker" with the user code "57900799408603"
#    And  I send a POST request to "ep_customer_action_detach_phone_verify_OTP_maker" user code "57900799408603" and phone number "916526290"
#    And I have a valid access token for the user "bini2"
#    And I send a POST request to "ep_user_login" with the passcode "Admin@7"
#    And I approve the access limit request for the user code "72758708821132" with status "DENIED" as a checker
#    Then the response status code should be 200
